...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  const thumbnailCard = 'https://files.catbox.moe/ryyt2j.jpg'; // Miniatura de la tarjeta
  const mainImage = 'https://files.catbox.moe/ryyt2j.jpg';     // Imagen principal del mensaje
